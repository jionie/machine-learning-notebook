import numpy as np 
from utils import entropy, partition_classes, information_gain, information_gain_ratio
    ...
    def fit(self, X, y):
        ...
        for split_attribute in current_features:
            ...
            for split_val in X_select:
                ...
                current_information_gain = information_gain(y, [y_left, y_right])
        ...
        left_tree = ID3(X_left, y_left, self.tree['max_depth'], self.tree['min_gain'])
        right_tree = ID3(X_right, y_right, self.tree['max_depth'], self.tree['min_gain'])
